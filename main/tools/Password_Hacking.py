        ...
        if option == "0":
            while True:
                ...
                if ask == "0":
                    ...
                    template.template("john", "john -h", github.strip(), {"Open-wall John": "https://www.openwall.com/john/","Password Cracking With John The Ripper": "https://www.section.io/engineering-education/password-cracking-with-john-the-ripper/","Tips and Tutorials of John": "https://www.varonis.com/blog/john-the-ripper"})
                elif ask == "2":
            ...
            while True:
                ...
                if ask == "0":
                    ...
                    template.template("r3bu5", "./r3bu5.sh", github.strip(), {"Github Repo of r3bu5": " https://github.com/k46-db0y/r3bu5"}, method="github",github_install="git clone https://github.com/k46-db0y/r3bu5 && cd r3bu5 && chmod +x r3bu5.sh",github_check="r3bu5")
                elif ask == "3":
                    ...
                    template.template("ShellPhish", "./shellphish.sh", github.strip(),{"Shellphish Tool": "https://www.kalilinux.in/2019/04/shellphish-phishing-page-creator.html"},method="github",github_install="git clone https://github.com/AbirHasan2005/ShellPhish && cd ShellPhish && chmod +x shellphish.sh",github_check="ShellPhish")
                elif ask == "5":
